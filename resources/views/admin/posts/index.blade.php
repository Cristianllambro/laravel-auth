        ...
        <div class="col-4">
            <div class="card h-100" style="width: 22rem;">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.posts.show', $item->id)}}" class="btn btn-primary px-3 me-2">Info</a>
                    <a href="{{route('admin.posts.edit', $item->id)}}" class="btn btn-primary px-3 me-2">Edit</a>
